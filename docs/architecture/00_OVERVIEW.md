...
- **Phaser 4.2.1**: Responsável pelo motor de jogo real-time, simulação física de corpos, colisões (Arcade Physics), renderização de partículas de sangue, geração procedimental do calabouço e animações do grid de jogo.
