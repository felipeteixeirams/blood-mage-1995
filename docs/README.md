...
* `docs/architecture/05_SPEC_AND_CONTEXT_DRIVEN_ENGINEERING.md` - **METODOLOGIA:** Guia mestre de Seleção de Modo (Conversacional vs Arquitetural vs Spec-Driven) e Context-Driven Engineering.
