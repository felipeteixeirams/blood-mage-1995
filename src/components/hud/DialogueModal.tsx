 ...
 *
 * Layout VN-style (Spec 16): retrato à esquerda (placeholder por ícone — sem puxar o
 * canvas do Phaser, ver nota de escopo original) + caixa de texto em 9-slice CSS ancorada
 * na base da tela, no lugar do modal centralizado anterior.
 */
