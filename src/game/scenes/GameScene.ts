    ...
    this.enemiesGroup.getChildren().forEach((enemyObj: any) => {
      ...
      if (enemy.active) {
        ...
        if (dist <= 200) {
          ...
          if (!isDead) {
            this.statusEffectSystem?.applyStatus(enemy, 'burning', 3500, Math.max(6, Math.round(novaDamage * 0.3)));
          }
    ...
    this.enemiesGroup.getChildren().forEach((enemyObj: any) => {
      ...
      if (enemy.active) {
        ...
        if (dist <= 150) {
          ...
          if (!isDead) {
            this.statusEffectSystem?.applyStatus(enemy, 'cursed', 4000, 15);
          }
    ...
    this.enemiesGroup.getChildren().forEach((enemyObj: any) => {
      ...
      if (enemy.active) {
        ...
        if (Phaser.Geom.Intersects.LineToCircle(beamLine, enemyCircle)) {
          ...
          if (!isDead) {
            this.statusEffectSystem?.applyStatus(enemy, 'cursed', 3500, 20);
          }
