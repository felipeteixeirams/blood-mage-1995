...
export class TitleScene extends Phaser.Scene {
  ...
  preload() {
    const uiAssets: { key: string; path: string }[] = [
      { key: "logo", path: "assets/ui/title-logo.png" },
      { key: "gargoyleTop", path: "assets/ui/gargoyle-top.png" },
      { key: "gargoyleBottom", path: "assets/ui/gargoyle-bottom.png" },
      { key: "torch", path: "assets/ui/torch.png" },
      { key: "altar", path: "assets/ui/altar.png" },
      { key: "runeArch", path: "assets/ui/rune-arch.png" },
      { key: "stoneTile", path: "assets/ui/stone-tile.jpg" },
      { key: "rockTile", path: "assets/ui/rock-tile.jpg" },
      { key: "uiCorner", path: "assets/ui/ui-corner.png" },
      { key: "uiPlaque", path: "assets/ui/ui-plaque.png" },
      { key: "uiGem", path: "assets/ui/ui-gem.png" },
      { key: "uiCap", path: "assets/ui/ui-slider-cap.png" },
    ];
